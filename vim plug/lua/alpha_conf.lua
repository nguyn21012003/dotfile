...
dashboard.section.buttons.val = {
  ...
  dashboard.button("1", "  > Python File Thesis", ":cd E:/codespace/luan_an/texfile/solution/pythonfile | Telescope file_browser<CR>"),
  dashboard.button("2", "  > Thesis of MsC", ":cd  E:/codespace/git/thesisMsC | Telescope file_browser<CR>"),
  dashboard.button("3", "  > Obsidian note", ":cd  E:/codespace/noteMD | Telescope file_browser<CR>"),
